...
namespace LinqWithCollections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ConsolePrinter.DisplaySongs(mySongs.GetAllByArtistOW(artist));
            ConsolePrinter.DisplaySongs(mySongs.GetAllByArtistQuerySyntax(artist));
            ConsolePrinter.DisplaySongs(mySongs.GetAllByArtistMethodSyntaxExpressionBodied(artist));
            ...
            Console.WriteLine("Played Count: {0}", mySongs.PlayedCountCalculatedProperty);
