...
namespace Assign07
{
    public partial class MainForm : Form
    {
        ...
        private decimal gstRate = 0.07m;
        private decimal pstRate = 0.05m;
        ...
        {
            labelCountTotalCreditHold.Text = "";
            ...
            clientVM = new ClientViewModel(pstRate, gstRate);
            setBindings();
            setupDataGridView();
        }
        ...
        private void setBindings()
        {
            ...
            labelCountTotalIsTaxable.DataBindings.Add("Text", clientVM, "CountTotalTaxableClients");
            labelCountTotalCreditHold.DataBindings.Add("Text", clientVM, "CountTotalCreditHold");
        ...
        private void setupDataGridView()
        {
            ...
            clientId.Width = 350;
            clientId.SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewClients.Columns.Add(clientId);
            ...
            DataGridViewCheckBoxColumn isTaxable = new DataGridViewCheckBoxColumn();
        ...
        private void ShowEditDialog(bool isNew)
        {
            ...
            if(isNew)
            {
                client = new Client(gstRate, pstRate);
            } else
            {
                client = (Client)clientVM.ClientSource[index];
            }

            clientVM.DisplayClient = client;
            using(ClientEditDialog dlg = new ClientEditDialog())
            {
                dlg.ClientVM = this.clientVM;
                ...
                if(dlg.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        client.ClientId = clientVM.ClientSource.Count + 1;
                        clientVM.ClientSource.Add(client);
                    } else
                    {
                        clientVM.ClientSource[index] = client;
                    }
                }
            }
        }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            if(client.ClientId == default)
            {
                client.ClientId = clientVM.ClientSource.Count + 1;
                clientVM.ClientSource.Add(client);
                dataGridViewClients.Rows[dataGridViewClients.Rows.Count - 1].Selected = true;
            } else
            {
                clientVM.ClientSource[index] = client;
            }
